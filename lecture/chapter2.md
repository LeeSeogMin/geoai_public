...
**그림 2.2** 면적을 보존하는 투영의 원리와 한국 경계 자료의 실제 계산 결과를 함께 보여 줌.
...
**그림 2.3** 같은 3km 조건도 좌표계와 거리 정의에 따라 권역 모양과 포함 건물 수가 달라진다. 빨간 점은 직선 3km 안이지만 주행 3km 밖인 건물이고, 초록 점은 직선 3km 밖이지만 주행 10분 안인 건물이다.
